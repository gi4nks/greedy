...
console.log('gameEditionName:', gameEditionName, '->', EditionAwareImportService.detectGameEdition(gameEditionName));
console.log('gameEditionVersion:', gameEditionVersion, '->', EditionAwareImportService.detectGameEdition(gameEditionVersion));
