...
import { Calendar, BookOpen, Edit, View, Plus } from "lucide-react";
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-base-content/70 mb-6">
              Create your first campaign to start tracking your D&D adventures,
            ...
            >
              ...
              <CardContent className="flex-1 flex flex-col">
                ...
                <div className="flex gap-2 pt-4 mt-auto">
                  ...
                  <Link href={`/campaigns/${campaign.id}/adventures`} className="flex-1">
                    <Button variant="neutral" className="gap-2 flex-1 w-full" size="sm">
