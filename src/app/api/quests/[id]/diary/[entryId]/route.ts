...
export async function PUT(
  ...
  try {
    ...
    if (!Number.isFinite(questId) || !Number.isFinite(entryIdNum)) {
    ...
    const result = await handlers.updateEntry(questId, entryIdNum, body);
...
export async function DELETE(
  ...
  try {
    ...
    try {
      await handlers.deleteEntry(questId, entryIdNum);
