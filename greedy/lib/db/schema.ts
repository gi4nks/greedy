...
export const magicItemAssignments = sqliteTable('magic_item_assignments', {
  id: integer('id').primaryKey({ autoIncrement: true }),
  magicItemId: integer('magic_item_id').references(() => magicItems.id, { onDelete: 'cascade' }).notNull(),
  ...
  magicItemIndex: index('idx_magic_item_assignments_magic_item').on(table.magicItemId),
  entityIndex: index('idx_magic_item_assignments_entity').on(table.entityType, table.entityId),
  campaignIndex: index('idx_magic_item_assignments_campaign').on(table.campaignId),
  uniqueAssignment: uniqueIndex('uniq_magic_item_assignment').on(table.magicItemId, table.entityType, table.entityId),
}));
