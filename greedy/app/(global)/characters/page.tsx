        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-base-content/70 mb-6">
              Characters are created within adventures. Start by creating a campaign and adventure first.
            </p>
            <Link href="/campaigns">
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1 flex-1">
                    ...
                    <div className="flex gap-2">
                      <Badge variant={character.characterType === 'pc' ? 'info' : 'warning'}>
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-4 text-sm">
                  ...
                  {Array.isArray(character.classes) && character.classes.length > 0 && (
                    <div>
                      <span className="font-semibold">Classes:</span> {character.classes.join(', ')}
                    </div>
                  )}
                </div>
                ...
                <div className="flex justify-end gap-2">
                  <Link href={`/campaigns/${character.adventure?.campaignId}/characters/${character.id}`}>
                    <Button variant="warning" className="gap-2" size="sm">
                      <View className="w-4 h-4" />
                      View
                    </Button>
                  </Link>
                  <Link href={`/campaigns/${character.adventure?.campaignId}/characters/${character.id}/edit`}>
