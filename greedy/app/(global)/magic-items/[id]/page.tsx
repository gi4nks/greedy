...
function buildAssignmentSummary(assignments: ParsedAssignment[]) {
  ...
  assignments.forEach((assignment) => {
    summary.set(
      ...
      (summary.get(assignment.entityType) ?? 0) + 1,
    );
  });
                ...
                <div key={entityType} className="space-y-4">
                  ...
                  <div className="space-y-4">
                    {assignments.map((assignment) => (
                      <div
                        key={assignment.id}
                        className="space-y-3 rounded-md border border-base-200 bg-base-100 p-4 text-sm"
                      >
                        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                          <div className="space-y-1">
                            ...
                            <div className="flex flex-wrap gap-2 text-xs text-base-content/60">
                              ...
                              {assignment.assignedDateLabel && (
                                <span>
                                  Assigned {assignment.assignedDateLabel}
                                </span>
                              )}
                            </div>
                          </div>
